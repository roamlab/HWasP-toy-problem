...
class MyBasePolicy_OptL_MultiSegments(StochasticPolicy):
...
class CompMechPolicy_OptL_MultiSegments_HwAsAction(MyBasePolicy_OptL_MultiSegments):
...
class CompMechPolicy_OptL_MultiSegments_HwAsPolicy(MyBasePolicy_OptL_MultiSegments):
    def __init__(self, env_spec,
                comp_policy_model, 
                mech_policy_model, 
                name='comp_mech_policy'):
