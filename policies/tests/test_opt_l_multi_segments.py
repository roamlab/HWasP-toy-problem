...
from policies.opt_l.models import MechPolicyModel_OptL_HwAsPolicy

from policies.opt_l.policies import CompMechPolicy_OptL_HwAsAction
from policies.opt_l.policies import CompMechPolicy_OptL_HwAsPolicy      


class TestPolicy_OptL_HwAsAction(unittest.TestCase):
    @classmethod
    def setupClass(cls):
    ...
    def test_mech_policy_model(self):
        print('\n Testing MechPolicyModel_OptL_HwAsAction ...')
        y1 = 0.1
        v1 = 0.0

        mech_policy_model = MechPolicyModel_OptL_HwAsAction(name='test_mech_policy_model', params=params)
    ...
    def test_comp_mech_policy(self):
        print('\n Testing CompMechPolicy_OptL_HwAsAction ...')
        y1 = 0.1
        v1 = 0.1
        ...
        mech_policy_model = MechPolicyModel_OptL_HwAsAction(params=params)

        with tf.compat.v1.Session() as sess:        
            comp_mech_policy = CompMechPolicy_OptL_HwAsAction(name='test_comp_mech_policy', 
                env_spec=env.spec, 
...
class TestPolicy_OptL_HwAsPolicy(unittest.TestCase):
    @classmethod
    def setupClass(cls):
        # runs once in class instantiation
        pass
    ...
    def test_mech_policy_model(self):
        print('\n Testing MechPolicyModel_OptL_HwAsPolicy ...')
        y1 = 0.1
        v1 = 0.0
        ...
        mech_policy_model = MechPolicyModel_OptL_HwAsPolicy(name='test_mech_policy_model', params=params)
    ...
    def test_comp_mech_policy(self):        
        ...
        env = TfEnv(MassSpringEnv_OptL_HwAsPolicy(params))
        ...
        comp_policy_model = MLPModel(output_dim=1, 
            ...
            output_b_init=tf.zeros_initializer(), 
            output_w_init=tf.zeros_initializer())
        mech_policy_model = MechPolicyModel_OptL_HwAsPolicy(params)


        with tf.compat.v1.Session() as sess:        
            comp_mech_policy = CompMechPolicy_OptL_HwAsPolicy(name='test_comp_mech_policy', 
                env_spec=env.spec, 
                comp_policy_model=comp_policy_model, 
                mech_policy_model=mech_policy_model)
