...
class MassSpringEnv_OptK_HwAsAction(gym.Env):
    ...
    def __init__(self, params):
        ...
        self.action_space = gym.spaces.Box(low=np.array([-self.half_force_range, self.k_lb]), high=np.array([self.half_force_range, self.k_ub]), dtype=np.float32) # 1st: redifined action pi, 2nd: original action f
