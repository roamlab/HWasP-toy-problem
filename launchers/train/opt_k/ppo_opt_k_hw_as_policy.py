...
if __name__=='__main__':
    ...
    run_experiment(run_task, exp_prefix='ppo_opt_k_hw_as_policy_{}_'.format(args.exp_id) + str(params.n_springs)+'_params', snapshot_mode='last', seed=args.seed, force_cpu=True)