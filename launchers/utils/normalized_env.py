'''
Adopted from garage NormalizedEnv class,
added the option to turn off action normalization
'''
import gym
import gym.spaces
...
class NormalizedEnv(gym.Wrapper):
    ...
    def step(self, action):
        ...
        """
        if self._normalize_action and isinstance(self.action_space, gym.spaces.Box):
