...
def run_task(snapshot_config, *_):
    ...
    with LocalTFRunner(snapshot_config=snapshot_config) as runner:
        env = TfEnv(MassSpringEnv_OptSpringStiffness())
        ...
        policy = CompMechPolicy_OptSpringStiffness(name='comp_mech_policy', 
                env_spec=env.spec, 
        ...
        runner.train(n_epochs=500, batch_size=2048, plot=False)
